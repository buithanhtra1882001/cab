...
namespace CAB.BuildingBlocks.EventBusRegistration
{
    public static class ServiceCollectionExtension
    {
            ...
            IConfiguration configuration)
        {
            ...
            var isAzureServiceBusEnable = bool.TryParse(configuration["EventBus:AzureServiceBusEnabled"], out var azureServiceBusEnabled) &&
                                       azureServiceBusEnabled;

            if (isAzureServiceBusEnable)
            {
                ...
                services.AddSingleton<IEventBus, EventBusServiceBus.EventBusServiceBus>(sp =>
                {
                    ...
                    return new EventBusServiceBus.EventBusServiceBus(
