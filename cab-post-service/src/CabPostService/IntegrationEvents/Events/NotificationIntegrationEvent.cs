...
namespace CabPostService.IntegrationEvents.Events
{
    public record NotificationIntegrationEvent : IntegrationEvent
    {
        ...
        public int? DonateAmount { get; set; } = null;
        public NotificationIntegrationEvent(List<Guid> userIds, UserInfo actor, Guid referenceId, string notificationType, int? donateAmount = null)
        {
            UserIds = userIds;
            Actor = actor;
