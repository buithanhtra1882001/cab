...
namespace CabPostService.Handlers.Post
{
    public partial class PostHandler :
        ICommandHandler<VoteUpPostCommand, bool>
    {
        public async Task<bool> Handle(
            VoteUpPostCommand request,
            CancellationToken cancellationToken)
        {
            ...
            eventBus.Publish(new NotificationIntegrationEvent
                (new List<Guid> { post.UserId }, actorInfo, Guid.Parse(post.Id), NotificationConstants.LikePost));
